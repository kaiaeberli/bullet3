...
class Kuka:
  ...
  def applyAction(self, motorCommands):
    ...
    if (self.useInverseKinematics):
      ...
      # for IK, need to only command position in 3D space and angle, and finger angle
      dx = motorCommands[0]
      dy = motorCommands[1]
      dz = motorCommands[2]
      da = motorCommands[3]
      ...
      # limit the movement of the EEF to allowed positions
      ...
      #fingers - set motor state, with a certain force, using a certain type of controller
      p.setJointMotorControl2(self.kukaUid,
                              7,
                              p.POSITION_CONTROL,
    ...
    # if not using inverse kinematics
    else:
